...
class Bullet(Sprite):
    """A class to manage bullets or sword throws fired by the mage or
    soldier. """
    ...
    def __init__(self, ap_game):
        ...
        self.bullet_image_right = [
            pygame.image.load("/Users/johnphillip/Desktop/alien_apocalypse"
                              "/AlienApocalypse/craftpix-891165-assassin "
                              "-mage-viking-free-pixel-art-game-heroes/Mage"
                              "/Fire_Extra/fire_right1.png"),
            pygame.image.load(
                "/Users/johnphillip/Desktop/alien_apocalypse/AlienApocalypse"
                "/craftpix-891165-assassin "
                "-mage-viking-free-pixel-art-game-heroes/Mage/Fire_Extra"
                "/fire_right2.png"),
            pygame.image.load(
                "/Users/johnphillip/Desktop/alien_apocalypse/craftpix-891165"
                "-assassin-mage-viking-free "
        ...
        self.rect = pygame.Rect(0, 0, self.settings.bullet_width,
                                self.settings.bullet_height, self.rect)
    ...
    def draw_bullet(self):
        ...
        if self.last_move == self.mage.moving_right:
            for bullet in self.bullet_image_right:
                self.screen.blit(self.screen, self.bullet_image_right,
                                 self.rect, bullet[1], 0, 0)
        elif self.last_move == self.mage.moving_left:
            for bullet in self.bullet_image_left:
                self.screen.blit(self.screen, self.bullet_image_left, self.rect,
                                 bullet[1], 0, 0)
